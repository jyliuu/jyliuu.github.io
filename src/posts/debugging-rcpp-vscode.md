---
id: 'debugging-rcpp-vscode'
title: 'Debugging Rcpp with VSCode'
date: 'July 17, 2025'
summary: 'A tutorial and reference guide for connecting the VSCode debugger to Rcpp code, with step-by-step instructions for setting up debugging on macOS.'
